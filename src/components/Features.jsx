...
export default function Features({ features = ["First Feature", "Second Feature", "Third Feature"], img = "./assets/test-1.png" }) {
  return (
    <RevealOnScroll>
      <section className="flex flex-col w-full mt-16 px-12 max-w-[1400px] mx-auto pb-10">
        ...
        <div className="flex flex-col justify-center items-center lg:flex-row gap-10">
          <img className="w-full lg:w-1/2 aspect-video border rounded-xl object-contain" src={img} alt="Feature image" />
